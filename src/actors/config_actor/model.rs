...
pub struct ConfigHandle {
    pub tx: mpsc::Sender<ConfigMsg>,
}

pub struct ConfigActor {
    pub(super) rx: mpsc::Receiver<ConfigMsg>,
...
pub enum ConfigMsg {
    GetGlobalConfig {
        reply: oneshot::Sender<SubsystemResult<GlobalConfig>>,
    },
    GetWorkspaceConfig {
        reply: oneshot::Sender<SubsystemResult<WorkspaceConfig>>,
    },
    GetCurrentProvider {
        reply: oneshot::Sender<SubsystemResult<CurrentProvider>>,
    },
    ...
    GetToolConfig {
        name: String,
        reply: oneshot::Sender<SubsystemResult<Value>>,
    },
}
